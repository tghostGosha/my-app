...
function CardsLists() {
  ...
  async function load(page = 1) {
    try {
      ...
      console.log(data);
      let Users = [...partnersData, ...data.data];
      setPartnersData(Users);
      showNavigation = (data.total_pages !== 0 && data.page < data.total_pages);
  ...
  console.log(showNavigation, "ddfsdfsf")
  return (
    <div>
      ...
      {showNavigation ? ( <button className="button__more" onClick={loadUserList}>
            Показать еще
            <svg
              width="18"
              height="10"
